...
def test_package_imports() -> None:
    ...
    assert pygooglehelper.__name__ == "pygooglehelper"


def test_all_modules_import() -> None:
    """Every module in the package imports without errors."""
    for info in pkgutil.walk_packages(pygooglehelper.__path__, prefix="pygooglehelper.", onerror=_raise_on_package_error):
